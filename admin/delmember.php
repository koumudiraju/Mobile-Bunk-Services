<?php 
    ...
    if(isset($_POST['delete'])){
        ...
        $_SESSION['delemp']='Member deleted successfully';
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top">
          ...
          <div class="container a">
              <div class="col-12">
                  <form action="delmember.php" method='POST'>
                    <div class="form-group">
                        <input type="text" class="form-control" placeholder="Enter Employee ID" name="id" required/>
                    </div>
                    <input type="submit" class="btnRegister" id="apply" onclick="apply()" name="delete" value="Delete"/>
